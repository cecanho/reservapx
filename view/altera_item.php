...
<div class="container">
    ...
    <br>
<div class="jumbotron">
    <h3>Atualiza/Altera Equipamento</h3>
    ...
    <form method="post">
        <table>
            ...
            <tr><td><strong>Descrição: </strong></td><td><input type="text" name="descricao" id="descricao" value="<?php echo $descricao; ?>" size="75" class="form-control"></td></tr>
            <tr><td><strong>Caminho da imagem: </strong></td><td><input type="text" name="imagem" id="imagem" value="<?php echo $imagem; ?>" size="75" class="form-control"></td></tr>
            <tr><td></td><td align="right"><input type="submit" name="caditem" id="caditem" value="Salvar" class="btn-success"></td></tr>
        </table>
    </form>
</divc>
    </div> <!-- /container -->
